...
File Name: users_nav.php
Description: Creates top navigation for registered user pages 
-->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    <li><a href="<?php echo $app_path?>index.php?action=show_user_home">Home</a></li>
